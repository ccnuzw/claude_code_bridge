...
CCB 8.1.6 включает Flutter source CCB Mobile в [`mobile/`](../mobile/) и публикует Android APK через GitHub Releases:

- [Скачать CCB Mobile v8.1.6 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.1.6/ccb-mobile-v8.1.6.apk)
