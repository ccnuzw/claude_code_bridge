...
CCB 8.1.5 inclut le code source Flutter de CCB Mobile dans [`mobile/`](../mobile/) et publie l'APK Android via GitHub Releases :

- [Télécharger l'APK CCB Mobile v8.1.5](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.1.5/ccb-mobile-v8.1.5.apk)
