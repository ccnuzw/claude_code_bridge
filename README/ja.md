...
CCB 8.0.14 では Flutter 版 CCB Mobile のソースが [`mobile/`](../mobile/) に含まれ、Android APK は GitHub Releases で公開されています。

- [CCB Mobile v8.0.12 APK をダウンロード](https://github.com/bfly123/claude_code_bridge/releases/download/v8.0.14/ccb-mobile-v8.0.14.apk)
