...
<details open>
<summary><b>v8.0.14</b> - README 目录整理与移动端发布面同步</summary>

- 根目录 `README.md` 已切回英文 GitHub 首页。
- 多语言 README 统一放入 [`README/`](./) 目录，中文版本为 [`zh.md`](zh.md)。
- Mobile App 链接、package metadata 和 release notes 继续对齐 8.0.14 APK。
...
- v8.0.12 引入多语言 README 并统一章节结构；当前多语言文件已整理到 `README/` 目录。
