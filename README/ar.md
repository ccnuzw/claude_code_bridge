...
يتضمن CCB 8.0.14 مصدر Flutter الخاص بـ CCB Mobile داخل [`mobile/`](../mobile/) وينشر Android APK عبر GitHub Releases:

- [تنزيل CCB Mobile v8.0.12 APK](https://github.com/bfly123/claude_code_bridge/releases/download/v8.0.14/ccb-mobile-v8.0.14.apk)
