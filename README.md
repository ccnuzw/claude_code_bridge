...
<p>
  <img src="https://img.shields.io/badge/version-8.0.18-orange.svg" alt="version">
...
CCB 8.0.18 已把 Flutter 版 CCB Mobile 源码放入 [`mobile/`](mobile/)，并在 GitHub Release 中发布 Android APK：

- [下载 CCB Mobile v8.0.18 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.0.18/ccb-mobile-v8.0.18.apk)
