...
| `CCB_RUNTIME_ACCELERATOR_SOCKET` | `<project>/.ccb/runtime-accelerator/accelerator.sock` | Override sidecar Unix socket. | Useful for smoke tests and staged rollout. |
